...
import com.example.myjeptdemo.BuildConfig
import com.example.myjeptdemo.MyApplication
import com.example.myjeptdemo.utils.DeviceUtil
...
class PublicParamsInterceptor : Interceptor {
    ...
    private val publicParams: Map<String, String>
        get() {
            ...
            params.put("deviceId", DeviceUtil.getDeviceId(MyApplication.getInstance()))
            return params
        }
